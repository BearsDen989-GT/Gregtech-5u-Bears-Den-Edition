...
public enum ItemList implements IItemContainer {
    ...
    FluidRegulator_LV, FluidRegulator_MV, FluidRegulator_HV, FluidRegulator_EV, FluidRegulator_IV,
    ...
    Drain_Adv,Vent_Air,PyrolyseOven,ToolHull_LV,ToolHull_MV,ToolHull_HV,Machine_Bricked_BlastFurnace,Casing_DenseBricks,Casing_Plastic,
    ...
    public static Fluid sOilExtraHeavy, sOilHeavy, sOilMedium, sOilLight, sNaturalGas, sNitricAcid, sBlueVitriol, sNickelSulfate;
