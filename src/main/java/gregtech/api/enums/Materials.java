...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
	...
	Technetium(781, TextureSet.SET_METALLIC, 1.0F, 0, 0, 1 | 2, 216, 200, 216, 0, "Technetium", 0, 0, 2430, 0, false, false, 3, 1, 1, Dyes.dyeLightGray, Element.Tc, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 3))),
	...
	PurpleAlloy(521, TextureSet.SET_DULL, 1.0F, 0, 0, 1 | 2, 224, 72, 232, 0, "Purple Alloy", 0, 0, -1, 0, false, false, 3, 5, 1, Dyes.dyePurple, 2, Arrays.asList(new MaterialStack(BlueAlloy, 1), new MaterialStack(RedAlloy, 1)), Arrays.asList(new TC_AspectStack(TC_Aspects.ELECTRUM, 3))),
