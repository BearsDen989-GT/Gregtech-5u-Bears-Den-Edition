...
public enum Materials implements IColorModulationContainer, ISubTagContainer {
	...
	Technetium(781, TextureSet.SET_METALLIC, 1.0F, 0, 0, 1 | 2, 216, 200, 216, 0, "Technetium", 0, 0, 2430, 2430, true, false, 3, 1, 1, Dyes.dyeLightGray, Element.Tc, Arrays.asList(new TC_AspectStack(TC_Aspects.METALLUM, 3))),
...
//	BloodSteel(-1, TextureSet.SET_METALLIC, 11.0F, 768, 4, 1 | 2 | 16 | 32 | 64 | 128, 142, 28, 0, 0, "Blood Steel", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeRed, 2, Arrays.asList(new MaterialStack(Steel, 3)), Arrays.asList(new TC_AspectStack(TC_Aspects.VICTUS, 8), new TC_AspectStack(TC_Aspects.IGNIS, 3))),
	...
	static {
		...
		SubTag.WASHING_GREENV.addTo(Nickel, Chromite, Chrome, Ilmenite, Iron, Magnetite, Tungstate, Andradite, Pyrite, Pentlandite);
