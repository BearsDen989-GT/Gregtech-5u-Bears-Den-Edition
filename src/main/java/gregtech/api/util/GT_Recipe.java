...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sPartAssemblerRecipes = new GT_Recipe_Map_Assembler(new HashSet<GT_Recipe>(300), "gt.recipe.partassembler", "Part Factory", null, RES_PATH_GUI + "basicmachines/PartAssembler", 6, 1, 1, 0, 1, E, 1, E, true, true);
