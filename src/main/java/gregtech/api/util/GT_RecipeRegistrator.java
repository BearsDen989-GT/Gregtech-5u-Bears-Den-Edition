...
public class GT_RecipeRegistrator {
    ...
    public static void registerReverseFluidSmelting(ItemStack aStack, Materials aMaterial, long aMaterialAmount, MaterialStack aByproduct) {
        ...
        boolean tHide = aStack.getUnlocalizedName().startsWith("gt.blockmachines")&&(GT5_Mod.gregtechproxy.mHideRecyclingRecipes);
        if(GT5_Mod.gregtechproxy.mHideRecyclingRecipes&&tData!=null&&tData.hasValidPrefixData()&&!(tData.mPrefix==OrePrefixes.dust||tData.mPrefix==OrePrefixes.ingot||tData.mPrefix==OrePrefixes.block|tData.mPrefix==OrePrefixes.plate)){tHide=true;}
    ...
    public static void registerReverseSmelting(ItemStack aStack, Materials aMaterial, long aMaterialAmount, boolean aAllowAlloySmelter) {
        ...
        boolean tHide = (aMaterial != Materials.Iron)&&(GT5_Mod.gregtechproxy.mHideRecyclingRecipes);
    ...
    public static void registerReverseArcSmelting(ItemStack aStack, ItemData aData) {
        ...
        for (MaterialStack tMaterial : aData.getAllMaterialStacks()) {
            ...
            if (tMaterial.mMaterial.contains(SubTag.METAL)) {
            	if(GT5_Mod.gregtechproxy.mArcSmeltIntoAnnealed){
                tMaterial.mMaterial = tMaterial.mMaterial.mSmeltInto.mArcSmeltInto;
            	}else{
        ...
        boolean tHide = !tIron && GT5_Mod.gregtechproxy.mHideRecyclingRecipes;
    ...
    public static void registerReverseMacerating(ItemStack aStack, ItemData aData, boolean aAllowHammer) {
        ...
        for (MaterialStack tMaterial : aData.getAllMaterialStacks())
            tAmount += tMaterial.mAmount * tMaterial.mMaterial.getMass();
        boolean tHide = (aData.mMaterial.mMaterial != Materials.Iron)&&(GT5_Mod.gregtechproxy.mHideRecyclingRecipes);
