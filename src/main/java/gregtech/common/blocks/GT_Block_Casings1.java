...
public class GT_Block_Casings1
    ...
    public int colorMultiplier(IBlockAccess aWorld, int aX, int aY, int aZ) {
        return aWorld.getBlockMetadata(aX, aY, aZ) > 9 ? super.colorMultiplier(aWorld, aX, aY, aZ) : gregtech.api.enums.Dyes.MACHINE_METAL.getColor().getRed() << 16 | gregtech.api.enums.Dyes.MACHINE_METAL.getColor().getGreen() << 8 | gregtech.api.enums.Dyes.MACHINE_METAL.getColor().getBlue();
    }
}
