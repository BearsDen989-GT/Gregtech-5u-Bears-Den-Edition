...
public class GT_MetaGenerated_Item_01
    ...
    public GT_MetaGenerated_Item_01() {
        ...
        setBurnValue(17000 + MaterialsOld.Wood.mMetaItemSubID, 1600);
        GT_OreDictUnificator.addToBlacklist(new ItemStack(this, 1, 17000 + MaterialsOld.Wood.mMetaItemSubID));
        GT_ModHandler.addCompressionRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Wood, 8L), new ItemStack(this, 1, 17000 + MaterialsOld.Wood.mMetaItemSubID));
        GregTech_API.registerCover(new ItemStack(this, 1, 17000 + MaterialsOld.Wood.mMetaItemSubID), new GT_RenderedTexture(Textures.BlockIcons.COVER_WOOD_PLATE), null);

        ItemStack tStack = new ItemStack(this, 1, 17000 + MaterialsOld.Wood.mMetaItemSubID);
        tStack.setStackDisplayName("The holy Planks of Sengir");
        GT_Utility.ItemNBT.addEnchantment(tStack, Enchantment.smite, 10);
        GT_ModHandler.addCraftingRecipe(tStack, GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"XXX", "XDX", "XXX", 'X', OrePrefixes.gem.get(MaterialsOld.NetherStar), 'D', new ItemStack(Blocks.dragon_egg, 1, OreDictionary.WILDCARD_VALUE)});

        ItemList.Credit_Greg_Copper.set(addItem(tLastID = 0, "Copper GT Credit", "0.125 Credits"));
        ItemList.Credit_Greg_Cupronickel.set(addItem(tLastID = 1, "Cupronickel GT Credit", "1 Credit", new ItemData(MaterialsOld.Cupronickel, 907200L)));
        ...
        ItemList.Coin_Gold_Ancient.set(addItem(tLastID = 8, "Ancient Gold Coin", "Found in ancient Ruins", new ItemData(MaterialsOld.Gold, 907200L), new TC_Aspects.TC_AspectStack(TC_Aspects.LUCRUM, 8L)));
        ItemList.Coin_Doge.set(addItem(tLastID = 9, "Doge Coin", "wow much coin how money so crypto plz mine v rich very currency wow", new ItemData(MaterialsOld.Brass, 907200L), new TC_Aspects.TC_AspectStack(TC_Aspects.LUCRUM, 1L)));
        ItemList.Coin_Chocolate.set(addItem(tLastID = 10, "Chocolate Coin", "Wrapped in Gold", new ItemData(MaterialsOld.Gold, OrePrefixes.foil.mMaterialAmount), new GT_FoodStat(1, 0.1F, EnumAction.eat, GT_OreDictUnificator.get(OrePrefixes.foil, MaterialsOld.Gold, 1L), true, false, false, Potion.moveSpeed.id, 200, 1, 100)));
        ...
        GT_ModHandler.addShapelessCraftingRecipe(ItemList.Coin_Chocolate.get(1L), new Object[]{OrePrefixes.dust.get(MaterialsOld.Cocoa), OrePrefixes.dust.get(MaterialsOld.Milk), OrePrefixes.dust.get(MaterialsOld.Sugar), OrePrefixes.foil.get(MaterialsOld.Gold)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Component_Minecart_Wheels_Iron.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{" h ", "RSR", " w ", 'R', OrePrefixes.ring.get(MaterialsOld.AnyIron), 'S', OrePrefixes.stick.get(MaterialsOld.AnyIron)});
        GT_ModHandler.addCraftingRecipe(ItemList.Component_Minecart_Wheels_Steel.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{" h ", "RSR", " w ", 'R', OrePrefixes.ring.get(MaterialsOld.Steel), 'S', OrePrefixes.stick.get(MaterialsOld.Steel)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Emtpy.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Emtpy, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Poison.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Poison, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Poison_Long.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Poison_Long, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Poison_Strong.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Poison_Strong, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Slowness.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Slowness, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Slowness_Long.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Slowness_Long, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Weakness.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Weakness, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Weakness_Long.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Weakness_Long, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Wooden_Glass_Holy_Water.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Holy_Water, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Wood)});

        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Emtpy.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Emtpy, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Poison.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Poison, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Poison_Long.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Poison_Long, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Poison_Strong.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Poison_Strong, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Slowness.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Slowness, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Slowness_Long.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Slowness_Long, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Weakness.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Weakness, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Weakness_Long.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Weakness_Long, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Arrow_Plastic_Glass_Holy_Water.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"  A", " S ", "F  ", 'A', ItemList.Arrow_Head_Glass_Holy_Water, 'F', OreDictNames.craftingFeather, 'S', OrePrefixes.stick.get(MaterialsOld.Plastic)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Shape_Empty.get(1L), GT_ModHandler.RecipeBits.MIRRORED | GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"hf", "PP", "PP", 'P', OrePrefixes.plate.get(MaterialsOld.Steel)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Shape_Slicer_Flat.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"hXS", " P ", "fXd", 'P', ItemList.Shape_Extruder_Block, 'X', OrePrefixes.plate.get(MaterialsOld.StainlessSteel), 'S', OrePrefixes.screw.get(MaterialsOld.StainlessSteel)});
        GT_ModHandler.addCraftingRecipe(ItemList.Shape_Slicer_Stripes.get(1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"hXS", "XPX", "fXd", 'P', ItemList.Shape_Extruder_Block, 'X', OrePrefixes.plate.get(MaterialsOld.StainlessSteel), 'S', OrePrefixes.screw.get(MaterialsOld.StainlessSteel)});

        ItemList.Fuel_Can_Plastic_Empty.set(addItem(tLastID = 400, "Empty Plastic Fuel Can", "Used to store Fuels", new ItemData(MaterialsOld.Plastic, OrePrefixes.plate.mMaterialAmount * 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 1L)));
        ItemList.Fuel_Can_Plastic_Filled.set(addItem(tLastID = 401, "Plastic Fuel Can", "Burns well in Diesel Generators", new ItemData(MaterialsOld.Plastic, OrePrefixes.plate.mMaterialAmount * 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 1L)));

        GT_ModHandler.addCraftingRecipe(ItemList.Fuel_Can_Plastic_Empty.get(7L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{" PP", "P P", "PPP", 'P', OrePrefixes.plate.get(MaterialsOld.Plastic)});

        ItemList.Spray_Empty.set(addItem(tLastID = 402, "Empty Spray Can", "Used for making Sprays", new ItemData(MaterialsOld.Tin, OrePrefixes.plate.mMaterialAmount * 2L, MaterialsOld.Redstone, OrePrefixes.dust.mMaterialAmount), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.MOTUS, 1L)));

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Redstone, 1L), GT_OreDictUnificator.get(OrePrefixes.cell, MaterialsOld.Empty, 1L), ItemList.Spray_Empty.get(1L), 800, 1);

        ItemList.Crate_Empty.set(addItem(tLastID = 403, "Empty Crate", "To Package lots of Material", new ItemData(MaterialsOld.Wood, MATERIAL_UNIT, MaterialsOld.Iron, OrePrefixes.screw.mMaterialAmount), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 2L)));

        GT_ModHandler.addCraftingRecipe(ItemList.Crate_Empty.get(4L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"SWS", "WdW", "SWS", 'W', OrePrefixes.plank.get(MaterialsOld.Wood), 'S', OrePrefixes.screw.get(MaterialsOld.AnyIron)});
        GT_ModHandler.addCraftingRecipe(ItemList.Crate_Empty.get(4L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"SWS", "WdW", "SWS", 'W', OrePrefixes.plank.get(MaterialsOld.Wood), 'S', OrePrefixes.screw.get(MaterialsOld.Steel)});

        ItemList.ThermosCan_Empty.set(addItem(tLastID = 404, "Empty Thermos Can", "Keeping hot things hot and cold things cold", new ItemData(MaterialsOld.Aluminium, OrePrefixes.plate.mMaterialAmount * 1L + 2L * OrePrefixes.ring.mMaterialAmount), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.GELUM, 1L)));

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plateDouble, MaterialsOld.Aluminium, 1L), GT_OreDictUnificator.get(OrePrefixes.ring, MaterialsOld.Aluminium, 2L), ItemList.ThermosCan_Empty.get(1L), 800, 1);

        ItemList.Large_Fluid_Cell_Steel.set(addItem(tLastID = 405, "Large Steel Fluid Cell", EMPTY_STRING, new ItemData(MaterialsOld.Steel, OrePrefixes.plate.mMaterialAmount * 8L + 4L * OrePrefixes.ring.mMaterialAmount), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 4L), new TC_Aspects.TC_AspectStack(TC_Aspects.AQUA, 2L)));
        setFluidContainerStats(32000 + tLastID, 32000L, 64L);

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plateDouble, MaterialsOld.Steel, 8L), GT_OreDictUnificator.get(OrePrefixes.ring, MaterialsOld.Steel, 4L), ItemList.Large_Fluid_Cell_Steel.get(1L), 100, 64);

        ItemList.Large_Fluid_Cell_TungstenSteel.set(addItem(tLastID = 406, "Large Tungstensteel Fluid Cell", EMPTY_STRING, new ItemData(MaterialsOld.TungstenSteel, OrePrefixes.plate.mMaterialAmount * 8L + 4L * OrePrefixes.ring.mMaterialAmount), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 6L), new TC_Aspects.TC_AspectStack(TC_Aspects.AQUA, 3L)));
        setFluidContainerStats(32000 + tLastID, 128000L, 32L);

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plateDouble, MaterialsOld.TungstenSteel, 8L), GT_OreDictUnificator.get(OrePrefixes.ring, MaterialsOld.TungstenSteel, 4L), ItemList.Large_Fluid_Cell_TungstenSteel.get(1L), 200, 256);
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.bolt, MaterialsOld.Wood, 1L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, MaterialsOld.Phosphor, 1L), ItemList.Tool_Matches.get(1L), 16, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.bolt, MaterialsOld.Wood, 1L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, MaterialsOld.Phosphorus, 1L), ItemList.Tool_Matches.get(1L), 16, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.bolt, MaterialsOld.Wood, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Phosphor, 1L), ItemList.Tool_Matches.get(4L), 64, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.bolt, MaterialsOld.Wood, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Phosphorus, 1L), ItemList.Tool_Matches.get(4L), 64, 16);
        RECIPE_ADDER_INSTANCE.addBoxingRecipe(ItemList.Tool_Matches.get(16L), GT_OreDictUnificator.get(OrePrefixes.plateDouble, MaterialsOld.Paper, 1L), ItemList.Tool_MatchBox_Full.get(1L), 64, 16);
        RECIPE_ADDER_INSTANCE.addUnboxingRecipe(ItemList.Tool_MatchBox_Full.get(1L), ItemList.Tool_Matches.get(16L), null, 32, 16);

        ItemList.Tool_Lighter_Invar_Empty.set(addItem(tLastID = 474, "Lighter (Empty)", EMPTY_STRING, new ItemData(MaterialsOld.Invar, OrePrefixes.plate.mMaterialAmount * 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L)));
        ItemList.Tool_Lighter_Invar_Used.set(addItem(tLastID = 475, "Lighter", EMPTY_STRING, new ItemData(MaterialsOld.Invar, OrePrefixes.plate.mMaterialAmount * 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 1L), SubTag.INVISIBLE));
        ItemList.Tool_Lighter_Invar_Full.set(addItem(tLastID = 476, "Lighter (Full)", EMPTY_STRING, new ItemData(MaterialsOld.Invar, OrePrefixes.plate.mMaterialAmount * 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 2L)));
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Invar, 2L), new ItemStack(Items.flint, 1), ItemList.Tool_Lighter_Invar_Empty.get(1L), 256, 16);

        ItemList.Tool_Lighter_Platinum_Empty.set(addItem(tLastID = 477, "Platinum Lighter (Empty)", "A known Prank Master is engraved on it", new ItemData(MaterialsOld.Platinum, OrePrefixes.plate.mMaterialAmount * 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.NEBRISUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L)));
        ItemList.Tool_Lighter_Platinum_Used.set(addItem(tLastID = 478, "Platinum Lighter", "A known Prank Master is engraved on it", new ItemData(MaterialsOld.Platinum, OrePrefixes.plate.mMaterialAmount * 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.IGNIS, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.NEBRISUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 1L), SubTag.INVISIBLE));
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Platinum, 2L), new ItemStack(Items.flint, 1), ItemList.Tool_Lighter_Platinum_Empty.get(1L), 256, 256);
        ...
        if (Loader.isModLoaded(MOD_ID_GC_MARS)) {
            ...
            GT_ModHandler.addCraftingRecipe(ItemList.Ingot_Heavy1.get(1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"BhB", "CAS", "B B", 'B', OrePrefixes.bolt.get(MaterialsOld.StainlessSteel), 'C', OrePrefixes.compressed.get(MaterialsOld.Bronze), 'A', OrePrefixes.compressed.get(MaterialsOld.Aluminium), 'S', OrePrefixes.compressed.get(MaterialsOld.Steel)});
            RECIPE_ADDER_INSTANCE.addImplosionRecipe(ItemList.Ingot_Heavy1.get(1L), 8, GT_ModHandler.getModItem(MOD_ID_GC_CORE, "item.heavyPlating", 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.StainlessSteel, 2L));
            GT_ModHandler.addCraftingRecipe(ItemList.Ingot_Heavy2.get(1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{" BB", "hPC", " BB", 'B', OrePrefixes.bolt.get(MaterialsOld.Tungsten), 'C', OrePrefixes.compressed.get(MaterialsOld.MeteoricIron), 'P', GT_ModHandler.getModItem(MOD_ID_GC_CORE, "item.heavyPlating", 1L)});
            RECIPE_ADDER_INSTANCE.addImplosionRecipe(ItemList.Ingot_Heavy2.get(1L), 8, GT_ModHandler.getModItem(MOD_ID_GC_MARS, "item.null", 1L, 3), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.Tungsten, 2L));
            GT_ModHandler.addCraftingRecipe(ItemList.Ingot_Heavy3.get(1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{" BB", "hPC", " BB", 'B', OrePrefixes.bolt.get(MaterialsOld.TungstenSteel), 'C', OrePrefixes.compressed.get(MaterialsOld.Desh), 'P', GT_ModHandler.getModItem(MOD_ID_GC_MARS, "item.null", 1L, 3)});
            RECIPE_ADDER_INSTANCE.addImplosionRecipe(ItemList.Ingot_Heavy3.get(1L), 8, GT_ModHandler.getModItem(MOD_ID_GC_MARS, "item.itemBasicAsteroids", 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.TungstenSteel, 2L));
        }
        ...
        GT_ModHandler.addRollingMachineRecipe(ItemList.Ingot_IridiumAlloy.get(1L), new Object[]{"IAI", "ADA", "IAI", 'D', GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.harderrecipes, "iridiumplate", true) ? OreDictNames.craftingIndustrialDiamond : OrePrefixes.dust.get(MaterialsOld.Diamond), 'A', OrePrefixes.plateAlloy.get("Advanced"), 'I', OrePrefixes.plate.get(MaterialsOld.Iridium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Ingot_IridiumAlloy.get(1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"IAI", "ADA", "IAI", 'D', GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.harderrecipes, "iridiumplate", true) ? OreDictNames.craftingIndustrialDiamond : OrePrefixes.dust.get(MaterialsOld.Diamond), 'A', OrePrefixes.plateAlloy.get("Advanced"), 'I', OrePrefixes.plate.get(MaterialsOld.Iridium)});
        RECIPE_ADDER_INSTANCE.addImplosionRecipe(ItemList.Ingot_IridiumAlloy.get(1L), 8, GT_OreDictUnificator.get(OrePrefixes.plateAlloy, MaterialsOld.Iridium, 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.DarkAsh, 4L));

        ItemList.Paper_Printed_Pages.set(addItem(tLastID = 481, "Printed Pages", "Used to make written Books", new ItemData(MaterialsOld.Paper, 10886400L), new Behaviour_PrintedPages(), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 2L)));
        ItemList.Paper_Magic_Empty.set(addItem(tLastID = 482, "Magic Paper", EMPTY_STRING, SubTag.INVISIBLE, new ItemData(MaterialsOld.Paper, MATERIAL_UNIT), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 1L)));
        ItemList.Paper_Magic_Page.set(addItem(tLastID = 483, "Enchanted Page", EMPTY_STRING, SubTag.INVISIBLE, new ItemData(MaterialsOld.Paper, MATERIAL_UNIT), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 2L)));
        ItemList.Paper_Magic_Pages.set(addItem(tLastID = 484, "Enchanted Pages", EMPTY_STRING, SubTag.INVISIBLE, new ItemData(MaterialsOld.Paper, 10886400L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.PRAECANTATIO, 4L)));
        ItemList.Paper_Punch_Card_Empty.set(addItem(tLastID = 485, "Punch Card", EMPTY_STRING, SubTag.INVISIBLE, new ItemData(MaterialsOld.Paper, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L)));
        ItemList.Paper_Punch_Card_Encoded.set(addItem(tLastID = 486, "Punched Card", EMPTY_STRING, SubTag.INVISIBLE, new ItemData(MaterialsOld.Paper, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 2L)));
        ItemList.Book_Written_01.set(addItem(tLastID = 487, "Book", EMPTY_STRING, new ItemData(MaterialsOld.Paper, 10886400L), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 2L)));
        ItemList.Book_Written_02.set(addItem(tLastID = 488, "Book", EMPTY_STRING, new ItemData(MaterialsOld.Paper, 10886400L), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 2L)));
        ItemList.Book_Written_03.set(addItem(tLastID = 489, "Book", EMPTY_STRING, new ItemData(MaterialsOld.Paper, 10886400L), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 2L)));

        ItemList.Schematic.set(addItem(tLastID = 490, "Schematic", "EMPTY", new ItemData(MaterialsOld.StainlessSteel, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.STRONTIO, 1L)));
        ItemList.Schematic_Crafting.set(addItem(tLastID = 491, "Schematic (Crafting)", "Crafts the Programmed Recipe", new ItemData(MaterialsOld.StainlessSteel, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 1L)));
        ItemList.Schematic_1by1.set(addItem(tLastID = 495, "Schematic (1x1)", "Crafts 1 Items as 1x1 (use in Packager)", new ItemData(MaterialsOld.StainlessSteel, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 1L)));
        ItemList.Schematic_2by2.set(addItem(tLastID = 496, "Schematic (2x2)", "Crafts 4 Items as 2x2 (use in Packager)", new ItemData(MaterialsOld.StainlessSteel, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 1L)));
        ItemList.Schematic_3by3.set(addItem(tLastID = 497, "Schematic (3x3)", "Crafts 9 Items as 3x3 (use in Packager)", new ItemData(MaterialsOld.StainlessSteel, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 1L)));
        ItemList.Schematic_Dust.set(addItem(tLastID = 498, "Schematic (Dusts)", "Combines Dusts (use in Packager)", new ItemData(MaterialsOld.StainlessSteel, 7257600L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 1L)));
        ...
        ItemList.Battery_Hull_LV.set(addItem(tLastID = 500, "Small Battery Hull", "An empty LV Battery Hull", new ItemData(MaterialsOld.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L)));
        ItemList.Battery_Hull_MV.set(addItem(tLastID = 501, "Medium Battery Hull", "An empty MV Battery Hull", new ItemData(MaterialsOld.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 6L), new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L)));
        ItemList.Battery_Hull_HV.set(addItem(tLastID = 502, "Large Battery Hull", "An empty HV Battery Hull", new ItemData(MaterialsOld.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 18L), new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 4L), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 4L), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 1L)));

        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Hull_LV.get(1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"C", "P", "P", 'P', OrePrefixes.plate.get(MaterialsOld.BatteryAlloy), 'C', OreDictNames.craftingWireTin});
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Hull_MV.get(1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"C C", "PPP", "PPP", 'P', OrePrefixes.plate.get(MaterialsOld.BatteryAlloy), 'C', OreDictNames.craftingWireCopper});
        ...
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Cadmium, 2L), ItemList.Battery_Hull_LV.get(1L), ItemList.Battery_RE_LV_Cadmium.get(1L), null, 100, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Lithium, 2L), ItemList.Battery_Hull_LV.get(1L), ItemList.Battery_RE_LV_Lithium.get(1L), null, 100, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Sodium, 2L), ItemList.Battery_Hull_LV.get(1L), ItemList.Battery_RE_LV_Sodium.get(1L), null, 100, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Cadmium, 8L), ItemList.Battery_Hull_MV.get(1L), ItemList.Battery_RE_MV_Cadmium.get(1L), null, 400, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Lithium, 8L), ItemList.Battery_Hull_MV.get(1L), ItemList.Battery_RE_MV_Lithium.get(1L), null, 400, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Sodium, 8L), ItemList.Battery_Hull_MV.get(1L), ItemList.Battery_RE_MV_Sodium.get(1L), null, 400, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Cadmium, 32L), ItemList.Battery_Hull_HV.get(1L), ItemList.Battery_RE_HV_Cadmium.get(1L), null, 1600, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Lithium, 32L), ItemList.Battery_Hull_HV.get(1L), ItemList.Battery_RE_HV_Lithium.get(1L), null, 1600, 2);
        RECIPE_ADDER_INSTANCE.addCannerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Sodium, 32L), ItemList.Battery_Hull_HV.get(1L), ItemList.Battery_RE_HV_Sodium.get(1L), null, 1600, 2);

        ItemList.Energy_LapotronicOrb.set(addItem(tLastID = 597, "Lapotronic Energy Orb", EMPTY_STRING, new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 16L), new TC_Aspects.TC_AspectStack(TC_Aspects.VITREUS, 16L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 16L), OrePrefixes.battery.get(MaterialsOld.Ultimate)));
        ...
        ItemList.Energy_LapotronicOrb2.set(addItem(tLastID = 599, "Lapotronic Energy Orb Cluster", EMPTY_STRING, new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 16L), new TC_Aspects.TC_AspectStack(TC_Aspects.VITREUS, 16L), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 16L), OrePrefixes.battery.get(MaterialsOld.Ultimate)));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Motor_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"CWR", "WIW", "RWC", 'I', OrePrefixes.stick.get(MaterialsOld.IronMagnetic), 'R', OrePrefixes.stick.get(MaterialsOld.Iron), 'W', OrePrefixes.wireGt01.get(MaterialsOld.AnyCopper), 'C', OrePrefixes.cableGt01.get(MaterialsOld.Tin)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Motor_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"CWR", "WIW", "RWC", 'I', OrePrefixes.stick.get(MaterialsOld.SteelMagnetic), 'R', OrePrefixes.stick.get(MaterialsOld.Steel), 'W', OrePrefixes.wireGt01.get(MaterialsOld.AnyCopper), 'C', OrePrefixes.cableGt01.get(MaterialsOld.Tin)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Motor_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"CWR", "WIW", "RWC", 'I', OrePrefixes.stick.get(MaterialsOld.SteelMagnetic), 'R', OrePrefixes.stick.get(MaterialsOld.Aluminium), 'W', OrePrefixes.wireGt02.get(MaterialsOld.AnyCopper), 'C', OrePrefixes.cableGt01.get(MaterialsOld.AnyCopper)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Motor_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"CWR", "WIW", "RWC", 'I', OrePrefixes.stick.get(MaterialsOld.SteelMagnetic), 'R', OrePrefixes.stick.get(MaterialsOld.StainlessSteel), 'W', OrePrefixes.wireGt04.get(MaterialsOld.AnyCopper), 'C', OrePrefixes.cableGt01.get(MaterialsOld.Gold)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Motor_EV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"CWR", "WIW", "RWC", 'I', OrePrefixes.stick.get(MaterialsOld.NeodymiumMagnetic), 'R', OrePrefixes.stick.get(MaterialsOld.Titanium), 'W', OrePrefixes.wireGt08.get(MaterialsOld.AnnealedCopper), 'C', OrePrefixes.cableGt01.get(MaterialsOld.Aluminium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Motor_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"CWR", "WIW", "RWC", 'I', OrePrefixes.stick.get(MaterialsOld.NeodymiumMagnetic), 'R', OrePrefixes.stick.get(MaterialsOld.TungstenSteel), 'W', OrePrefixes.wireGt16.get(MaterialsOld.AnnealedCopper), 'C', OrePrefixes.cableGt01.get(MaterialsOld.Tungsten)});
    	...
    	RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Electric_Pump_LV.get(1L), GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Basic, 2), ItemList.FluidRegulator_LV.get(1L), 800, 4);
    	RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Electric_Pump_MV.get(1L), GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Good, 2), ItemList.FluidRegulator_LV.get(1L), 800, 4);
    	RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Electric_Pump_HV.get(1L), GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Advanced, 2), ItemList.FluidRegulator_LV.get(1L), 800, 4);
    	RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Electric_Pump_EV.get(1L), GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Elite, 2), ItemList.FluidRegulator_LV.get(1L), 800, 4);
    	RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Electric_Pump_IV.get(1L), GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Master, 2), ItemList.FluidRegulator_LV.get(1L), 800, 4);
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.ToolHull_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SNT", "GMG", "PBP", 'T', ToolDictNames.craftingToolScrewdriver, 'M', ItemList.Electric_Motor_LV, 'P', OrePrefixes.plate.get(MaterialsOld.StainlessSteel), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.StainlessSteel), 'S', OrePrefixes.screw.get(MaterialsOld.StainlessSteel), 'B', ItemList.Battery_Hull_LV});
        GT_ModHandler.addCraftingRecipe(ItemList.ToolHull_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SNT", "GMG", "PBP", 'T', ToolDictNames.craftingToolScrewdriver, 'M', ItemList.Electric_Motor_MV, 'P', OrePrefixes.plate.get(MaterialsOld.Titanium), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.Titanium), 'S', OrePrefixes.screw.get(MaterialsOld.Titanium), 'B', ItemList.Battery_Hull_MV});
        GT_ModHandler.addCraftingRecipe(ItemList.ToolHull_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SNT", "GMG", "PBP", 'T', ToolDictNames.craftingToolScrewdriver, 'M', ItemList.Electric_Motor_HV, 'P', OrePrefixes.plate.get(MaterialsOld.TungstenSteel), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.TungstenSteel), 'S', OrePrefixes.screw.get(MaterialsOld.TungstenSteel), 'B', ItemList.Battery_Hull_HV});

        //Retrying to fix this, without breaking IHL compat.
        /*ItemList.Rotor_LV.set(addItem(tLastID = 620, "Tin Rotor", EMPTY_STRING, new Object[]{OrePrefixes.rotor.get(MaterialsOld.Tin), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.MOTUS, 1L)}));
        ItemList.Rotor_MV.set(addItem(tLastID = 621, "Bronze Rotor", EMPTY_STRING, new Object[]{OrePrefixes.rotor.get(MaterialsOld.Bronze), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2L), new TC_Aspects.TC_AspectStack(TC_Aspects.MOTUS, 2L)}));
        ItemList.Rotor_HV.set(addItem(tLastID = 622, "Steel Rotor", EMPTY_STRING, new Object[]{OrePrefixes.rotor.get(MaterialsOld.Steel), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 4L), new TC_Aspects.TC_AspectStack(TC_Aspects.MOTUS, 4L)}));
        ItemList.Rotor_EV.set(addItem(tLastID = 623, "Stainless Steel Rotor", EMPTY_STRING, new Object[]{OrePrefixes.rotor.get(MaterialsOld.StainlessSteel), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 8L), new TC_Aspects.TC_AspectStack(TC_Aspects.MOTUS, 8L)}));
        ItemList.Rotor_IV.set(addItem(tLastID = 624, "Tungstensteel Rotor", EMPTY_STRING, new Object[]{OrePrefixes.rotor.get(MaterialsOld.TungstenSteel), new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 16L), new TC_Aspects.TC_AspectStack(TC_Aspects.MOTUS, 16L)}));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Pump_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SXO", "dPw", "OMW", 'M', ItemList.Electric_Motor_LV, 'O', OrePrefixes.ring.get(MaterialsOld.Rubber), 'X', OrePrefixes.rotor.get(MaterialsOld.Tin), 'S', OrePrefixes.screw.get(MaterialsOld.Tin), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Tin), 'P', OrePrefixes.pipeMedium.get(MaterialsOld.Bronze)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Pump_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SXO", "dPw", "OMW", 'M', ItemList.Electric_Motor_MV, 'O', OrePrefixes.ring.get(MaterialsOld.Rubber), 'X', OrePrefixes.rotor.get(MaterialsOld.Bronze), 'S', OrePrefixes.screw.get(MaterialsOld.Bronze), 'W', OrePrefixes.cableGt01.get(MaterialsOld.AnyCopper), 'P', OrePrefixes.pipeMedium.get(MaterialsOld.Steel)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Pump_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SXO", "dPw", "OMW", 'M', ItemList.Electric_Motor_HV, 'O', OrePrefixes.ring.get(MaterialsOld.Rubber), 'X', OrePrefixes.rotor.get(MaterialsOld.Steel), 'S', OrePrefixes.screw.get(MaterialsOld.Steel), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Gold), 'P', OrePrefixes.pipeMedium.get(MaterialsOld.StainlessSteel)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Pump_EV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SXO", "dPw", "OMW", 'M', ItemList.Electric_Motor_EV, 'O', OrePrefixes.ring.get(MaterialsOld.Rubber), 'X', OrePrefixes.rotor.get(MaterialsOld.StainlessSteel), 'S', OrePrefixes.screw.get(MaterialsOld.StainlessSteel), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Aluminium), 'P', OrePrefixes.pipeMedium.get(MaterialsOld.Titanium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Pump_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SXO", "dPw", "OMW", 'M', ItemList.Electric_Motor_IV, 'O', OrePrefixes.ring.get(MaterialsOld.Rubber), 'X', OrePrefixes.rotor.get(MaterialsOld.TungstenSteel), 'S', OrePrefixes.screw.get(MaterialsOld.TungstenSteel), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Tungsten), 'P', OrePrefixes.pipeMedium.get(MaterialsOld.TungstenSteel)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Piston_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"PPP", "CSS", "CMG", 'P', OrePrefixes.plate.get(MaterialsOld.Steel), 'S', OrePrefixes.stick.get(MaterialsOld.Steel), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.Steel), 'M', ItemList.Electric_Motor_LV, 'C', OrePrefixes.cableGt01.get(MaterialsOld.Tin)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Piston_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"PPP", "CSS", "CMG", 'P', OrePrefixes.plate.get(MaterialsOld.Aluminium), 'S', OrePrefixes.stick.get(MaterialsOld.Aluminium), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.Aluminium), 'M', ItemList.Electric_Motor_MV, 'C', OrePrefixes.cableGt01.get(MaterialsOld.AnyCopper)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Piston_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"PPP", "CSS", "CMG", 'P', OrePrefixes.plate.get(MaterialsOld.StainlessSteel), 'S', OrePrefixes.stick.get(MaterialsOld.StainlessSteel), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.StainlessSteel), 'M', ItemList.Electric_Motor_HV, 'C', OrePrefixes.cableGt01.get(MaterialsOld.Gold)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Piston_EV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"PPP", "CSS", "CMG", 'P', OrePrefixes.plate.get(MaterialsOld.Titanium), 'S', OrePrefixes.stick.get(MaterialsOld.Titanium), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.Titanium), 'M', ItemList.Electric_Motor_EV, 'C', OrePrefixes.cableGt01.get(MaterialsOld.Aluminium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Electric_Piston_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"PPP", "CSS", "CMG", 'P', OrePrefixes.plate.get(MaterialsOld.TungstenSteel), 'S', OrePrefixes.stick.get(MaterialsOld.TungstenSteel), 'G', OrePrefixes.gearGtSmall.get(MaterialsOld.TungstenSteel), 'M', ItemList.Electric_Motor_IV, 'C', OrePrefixes.cableGt01.get(MaterialsOld.Tungsten)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Field_Generator_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"WCW", "CGC", "WCW", 'G', OrePrefixes.gem.get(MaterialsOld.EnderPearl), 'C', OrePrefixes.circuit.get(MaterialsOld.Basic), 'W', OrePrefixes.wireGt01.get(MaterialsOld.Osmium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Field_Generator_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"WCW", "CGC", "WCW", 'G', OrePrefixes.gem.get(MaterialsOld.EnderEye), 'C', OrePrefixes.circuit.get(MaterialsOld.Good), 'W', OrePrefixes.wireGt02.get(MaterialsOld.Osmium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Field_Generator_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"WCW", "CGC", "WCW", 'G', OrePrefixes.gem.get(MaterialsOld.NetherStar), 'C', OrePrefixes.circuit.get(MaterialsOld.Advanced), 'W', OrePrefixes.wireGt04.get(MaterialsOld.Osmium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Field_Generator_EV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"WCW", "CGC", "WCW", 'G', OrePrefixes.gem.get(MaterialsOld.NetherStar), 'C', OrePrefixes.circuit.get(MaterialsOld.Elite), 'W', OrePrefixes.wireGt08.get(MaterialsOld.Osmium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Field_Generator_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"WCW", "CGC", "WCW", 'G', OrePrefixes.gem.get(MaterialsOld.NetherStar), 'C', OrePrefixes.circuit.get(MaterialsOld.Master), 'W', OrePrefixes.wireGt16.get(MaterialsOld.Osmium)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Emitter_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SSC", "WQS", "CWS", 'Q', OrePrefixes.gem.get(MaterialsOld.Quartzite), 'S', OrePrefixes.stick.get(MaterialsOld.Brass), 'C', OrePrefixes.circuit.get(MaterialsOld.Basic), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Tin)});
        GT_ModHandler.addCraftingRecipe(ItemList.Emitter_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SSC", "WQS", "CWS", 'Q', OrePrefixes.gem.get(MaterialsOld.NetherQuartz), 'S', OrePrefixes.stick.get(MaterialsOld.Electrum), 'C', OrePrefixes.circuit.get(MaterialsOld.Good), 'W', OrePrefixes.cableGt01.get(MaterialsOld.AnyCopper)});
        GT_ModHandler.addCraftingRecipe(ItemList.Emitter_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SSC", "WQS", "CWS", 'Q', OrePrefixes.gem.get(MaterialsOld.Emerald), 'S', OrePrefixes.stick.get(MaterialsOld.Chrome), 'C', OrePrefixes.circuit.get(MaterialsOld.Advanced), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Gold)});
        GT_ModHandler.addCraftingRecipe(ItemList.Emitter_EV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SSC", "WQS", "CWS", 'Q', OrePrefixes.gem.get(MaterialsOld.EnderPearl), 'S', OrePrefixes.stick.get(MaterialsOld.Platinum), 'C', OrePrefixes.circuit.get(MaterialsOld.Elite), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Aluminium)});
        GT_ModHandler.addCraftingRecipe(ItemList.Emitter_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"SSC", "WQS", "CWS", 'Q', OrePrefixes.gem.get(MaterialsOld.EnderEye), 'S', OrePrefixes.stick.get(MaterialsOld.Osmium), 'C', OrePrefixes.circuit.get(MaterialsOld.Master), 'W', OrePrefixes.cableGt01.get(MaterialsOld.Tungsten)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Sensor_LV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"P Q", "PS ", "CPP", 'Q', OrePrefixes.gem.get(MaterialsOld.Quartzite), 'S', OrePrefixes.stick.get(MaterialsOld.Brass), 'P', OrePrefixes.plate.get(MaterialsOld.Steel), 'C', OrePrefixes.circuit.get(MaterialsOld.Basic)});
        GT_ModHandler.addCraftingRecipe(ItemList.Sensor_MV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"P Q", "PS ", "CPP", 'Q', OrePrefixes.gem.get(MaterialsOld.NetherQuartz), 'S', OrePrefixes.stick.get(MaterialsOld.Electrum), 'P', OrePrefixes.plate.get(MaterialsOld.Aluminium), 'C', OrePrefixes.circuit.get(MaterialsOld.Good)});
        GT_ModHandler.addCraftingRecipe(ItemList.Sensor_HV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"P Q", "PS ", "CPP", 'Q', OrePrefixes.gem.get(MaterialsOld.Emerald), 'S', OrePrefixes.stick.get(MaterialsOld.Chrome), 'P', OrePrefixes.plate.get(MaterialsOld.StainlessSteel), 'C', OrePrefixes.circuit.get(MaterialsOld.Advanced)});
        GT_ModHandler.addCraftingRecipe(ItemList.Sensor_EV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"P Q", "PS ", "CPP", 'Q', OrePrefixes.gem.get(MaterialsOld.EnderPearl), 'S', OrePrefixes.stick.get(MaterialsOld.Platinum), 'P', OrePrefixes.plate.get(MaterialsOld.Titanium), 'C', OrePrefixes.circuit.get(MaterialsOld.Elite)});
        GT_ModHandler.addCraftingRecipe(ItemList.Sensor_IV.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"P Q", "PS ", "CPP", 'Q', OrePrefixes.gem.get(MaterialsOld.EnderEye), 'S', OrePrefixes.stick.get(MaterialsOld.Osmium), 'P', OrePrefixes.plate.get(MaterialsOld.TungstenSteel), 'C', OrePrefixes.circuit.get(MaterialsOld.Master)});

        ItemList.Circuit_Primitive.set(addItem(tLastID = 700, "NAND Chip", "A very simple Circuit", OrePrefixes.circuit.get(MaterialsOld.Primitive)));
        ItemList.Circuit_Basic.set(addItem(tLastID = 701, "Basic Electronic Circuit", "A basic Circuit", OrePrefixes.circuit.get(MaterialsOld.Basic)));
        ItemList.Circuit_Good.set(addItem(tLastID = 702, "Good Electronic Circuit", "A good Circuit", OrePrefixes.circuit.get(MaterialsOld.Good)));
        ItemList.Circuit_Advanced.set(addItem(tLastID = 703, "Advanced Circuit", "An advanced Circuit", OrePrefixes.circuit.get(MaterialsOld.Advanced)));
        ItemList.Circuit_Data.set(addItem(tLastID = 704, "Data Storage Circuit", "A Data Storage Chip", OrePrefixes.circuit.get(MaterialsOld.Data)));
        ItemList.Circuit_Elite.set(addItem(tLastID = 705, "Data Control Circuit", "A Processor", OrePrefixes.circuit.get(MaterialsOld.Elite)));
        ItemList.Circuit_Master.set(addItem(tLastID = 706, "Energy Flow Circuit", "A High Voltage Processor", OrePrefixes.circuit.get(MaterialsOld.Master)));
        ItemList.Tool_DataOrb.set(addItem(tLastID = 707, "Data Orb", "A High Capacity Data Storage", OrePrefixes.circuit.get(MaterialsOld.Ultimate), SubTag.NO_UNIFICATION, new Behaviour_DataOrb()));
        ...
        ItemList.Tool_DataStick.set(addItem(tLastID = 708, "Data Stick", "A Low Capacity Data Storage", OrePrefixes.circuit.get(MaterialsOld.Data), SubTag.NO_UNIFICATION, new Behaviour_DataStick()));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Component_Sawblade_Diamond.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{" D ", "DGD", " D ", 'D', OrePrefixes.dustSmall.get(MaterialsOld.Diamond), 'G', OrePrefixes.gearGt.get(MaterialsOld.CobaltBrass)});
        GT_ModHandler.addCraftingRecipe(ItemList.Component_Grinder_Diamond.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"DSD", "SIS", "DSD", 'I', OreDictNames.craftingIndustrialDiamond, 'D', OrePrefixes.dust.get(MaterialsOld.Diamond), 'S', OrePrefixes.plate.get(MaterialsOld.Steel)});
        GT_ModHandler.addCraftingRecipe(ItemList.Component_Grinder_Tungsten.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"TST", "SIS", "TST", 'I', OreDictNames.craftingIndustrialDiamond, 'T', OrePrefixes.plate.get(MaterialsOld.Tungsten), 'S', OrePrefixes.plate.get(MaterialsOld.Steel)});
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Plastic, 2L), ItemList.Upgrade_Muffler.get(1L), 1600, 2);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Wood, 2L), ItemList.Upgrade_Muffler.get(1L), 1600, 2);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Plastic, 2L), ItemList.Upgrade_Muffler.get(1L), 1600, 2);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Wood, 2L), ItemList.Upgrade_Muffler.get(1L), 1600, 2);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.WroughtIron, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Plastic, 2L), ItemList.Upgrade_Muffler.get(1L), 1600, 2);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.WroughtIron, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Wood, 2L), ItemList.Upgrade_Muffler.get(1L), 1600, 2);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iridium, 1L), ItemList.Upgrade_Lock.get(1L), 6400, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iridium, 1L), ItemList.Upgrade_Lock.get(1L), 6400, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.WroughtIron, 1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iridium, 1L), ItemList.Upgrade_Lock.get(1L), 6400, 16);
        
        ItemList.Component_Filter.set(addItem(tLastID = 729, "Item Filter", EMPTY_STRING, new ItemData(MaterialsOld.Zinc, OrePrefixes.foil.mMaterialAmount * 16L), new TC_Aspects.TC_AspectStack(TC_Aspects.COGNITIO, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.SENSUS, 1L), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 1L), OreDictNames.craftingFilter));

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_ModHandler.getIC2Item("carbonMesh", 4L), GT_OreDictUnificator.get(OrePrefixes.foil, MaterialsOld.Zinc, 16L), ItemList.Component_Filter.get(1L), 1600, 32);
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Sensor_EV.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Titanium, 1L), ItemList.Cover_PlayerDetector.get(1L), 3200, 128);
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Cover_Shutter.get(1L), GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Advanced, 2), ItemList.FluidFilter.get(1L), 800, 4);
        
        GT_ModHandler.addCraftingRecipe(ItemList.Cover_Screen.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"AGA", "RPB", "ALA", 'A', OrePrefixes.plate.get(MaterialsOld.Aluminium), 'L', OrePrefixes.dust.get(MaterialsOld.Glowstone), 'R', Dyes.dyeRed, 'G', Dyes.dyeLime, 'B', Dyes.dyeBlue, 'P', OrePrefixes.plate.get(MaterialsOld.Glass)});

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 2L), new ItemStack(Items.iron_door, 1), ItemList.Cover_Shutter.get(2L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 2L), new ItemStack(Items.iron_door, 1), ItemList.Cover_Shutter.get(2L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.WroughtIron, 2L), new ItemStack(Items.iron_door, 1), ItemList.Cover_Shutter.get(2L), 800, 16);

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Bronze, 1L), new ItemStack(Blocks.iron_bars, 2), ItemList.Cover_Drain.get(1L), 800, 16);

        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 2L), new ItemStack(Blocks.iron_bars, 2), ItemList.Drain_Adv.get(1L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 2L), new ItemStack(Blocks.iron_bars, 2), ItemList.Drain_Adv.get(1L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.WroughtIron, 2L), new ItemStack(Blocks.iron_bars, 2), ItemList.Drain_Adv.get(1L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 1L), new ItemStack(Blocks.crafting_table, 1), ItemList.Cover_Crafting.get(1L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 1L), new ItemStack(Blocks.crafting_table, 1), ItemList.Cover_Crafting.get(1L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.WroughtIron, 1L), new ItemStack(Blocks.crafting_table, 1), ItemList.Cover_Crafting.get(1L), 800, 16);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Iron, 2L), ItemList.Electric_Pump_LV.get(1L), ItemList.Vent_Air.get(1L), 800, 16);
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Tool_Scanner.get(1L), GT_ModHandler.RecipeBits.DISMANTLEABLE | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.REVERSIBLE, new Object[]{"EPR", "CSC", "PBP", 'C', OrePrefixes.circuit.get(MaterialsOld.Advanced), 'P', OrePrefixes.plate.get(MaterialsOld.Aluminium), 'E', ItemList.Emitter_MV, 'R', ItemList.Sensor_MV, 'S', ItemList.Cover_Screen, 'B', ItemList.Battery_RE_MV_Lithium});
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, MaterialsOld.Good, 4L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.StainlessSteel, 2L), ItemList.Schematic.get(1L), 3200, 4);
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Emitter_EV.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.StainlessSteel, 1L), ItemList.Cover_RedstoneTransmitterExternal.get(1L), 3200, 128);
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Sensor_EV.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.StainlessSteel, 1L), ItemList.Cover_RedstoneReceiverExternal.get(1L), 3200, 128);
        ...
        RECIPE_ADDER_INSTANCE.addAssemblerRecipe(ItemList.Emitter_MV.get(1L), GT_OreDictUnificator.get(OrePrefixes.plate, MaterialsOld.Aluminium, 1L), ItemList.Cover_NeedsMaintainance.get(1L), 600, 24);
    }

    public boolean onEntityItemUpdate(EntityItem aItemEntity) {
        int aDamage = aItemEntity.getEntityItem().getItemDamage();
        if ((aDamage < 32000) && (aDamage >= 0) && (!aItemEntity.worldObj.isRemote)) {
            MaterialsOld aMaterial = GregTech_API.sGeneratedMaterials[(aDamage % 1000)];
    ...
    public boolean doesMaterialAllowGeneration(OrePrefixes aPrefix, MaterialsOld aMaterial) {
