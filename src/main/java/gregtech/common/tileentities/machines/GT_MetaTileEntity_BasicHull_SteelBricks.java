...
public class GT_MetaTileEntity_BasicHull_SteelBricks
    ...
    public ITexture[][][] getTextureSet(ITexture[] aTextures) {
        ...
        for (byte i = -1; i < 16; i = (byte) (i + 1)) {
            ...
            ITexture[] tmp1 = {new GT_RenderedTexture(Textures.BlockIcons.MACHINE_STEELBRICKS_TOP, Dyes.getModulation(i, Dyes._NULL.getRGBa()))};
            rTextures[1][(i + 1)] = tmp1;
            ITexture[] tmp2 = {new GT_RenderedTexture(Textures.BlockIcons.MACHINE_STEELBRICKS_SIDE, Dyes.getModulation(i, Dyes._NULL.getRGBa()))};
