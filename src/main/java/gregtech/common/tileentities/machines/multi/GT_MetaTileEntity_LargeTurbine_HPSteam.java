    ...
    int fluidIntoPower(ArrayList<FluidStack> aFluids, int aOptFlow, int aBaseEff) {
        ...
        for (int i = 0; i < aFluids.size() && remainingFlow > 0; i++) {
            ...
            if (fluidName.equals("ic2.fluidSuperheatedSteam")) {
                ...
                if (!achievement) {
                    GT5_Mod.instance.achievements.issueAchievement(this.getBaseMetaTileEntity().getWorld().getPlayerEntityByName(this.getBaseMetaTileEntity().getOwnerName()), "efficientsteam");
                    achievement = true;
                }
