...
public class ProcessingCrop implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, MaterialsOld aMaterial, String aOreDictName, String aModName, net.minecraft.item.ItemStack aStack) {
        ...
        if (aOreDictName.equals("cropTea")) {
            ...
            GT_ModHandler.addPulverisationRecipe(aStack, GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Chili, 1L));
        } else if (aOreDictName.equals("cropCoffee")) {
            GT_ModHandler.addPulverisationRecipe(aStack, GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Coffee, 1L));
