...
public class ProcessingDust implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void registerOre(OrePrefixes aPrefix, MaterialsOld aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        if ((null != (tStack = GT_OreDictUnificator.get(OrePrefixes.ingot, aMaterial.mSmeltInto, 1L))) && (!aMaterial.contains(SubTag.NO_SMELTING))) {
            ...
            if (((OrePrefixes.block.isIgnored(aMaterial)) || (null == GT_OreDictUnificator.get(OrePrefixes.block, aMaterial, 1L))) && (aMaterial != MaterialsOld.GraniteRed) && (aMaterial != MaterialsOld.GraniteBlack) && (aMaterial != MaterialsOld.Glass) && (aMaterial != MaterialsOld.Obsidian) && (aMaterial != MaterialsOld.Glowstone) && (aMaterial != MaterialsOld.Paper)) {
        ...
        if (aMaterial.contains(SubTag.CRYSTALLISABLE)) {
            RECIPE_ADDER_INSTANCE.addAutoclaveRecipe(GT_Utility.copyAmount(1L, aStack), MaterialsOld.Water.getFluid(200L), GT_OreDictUnificator.get(OrePrefixes.gem, aMaterial, 1L), 7000, 2000, 24);
        ...
        switch (aMaterial) {
            ...
            case CertusQuartz:
                ...
                break;
            case MeatRaw:
                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.MeatCooked, 1L));
                break;
            case Mercury:
...
//            case Chalcopyrite:
//            case Malachite:
//                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.nugget, MaterialsOld.Copper, 1L));
//                break;
//            case Pentlandite:
//                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.nugget, MaterialsOld.Nickel, 4L));
//                break;
//            case Garnierite:
//                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.ingot, MaterialsOld.Nickel, 1L));
//                break;
//            case Cassiterite:
//            case CassiteriteSand:
//                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.ingot, MaterialsOld.Tin, 1L));
//                break;
//            case Magnetite:
//            case VanadiumMagnetite:
//           case BasalticMineralSand:
//            case GraniticMineralSand:
//                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.nugget, MaterialsOld.Iron, 3L));
//                break;
//            case YellowLimonite:
//            case BrownLimonite:
//            case BandedIron:
//                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.ingot, MaterialsOld.Iron, 1L));
//                break;
            case Coal:
                GT_ModHandler.addLiquidTransposerFillRecipe(GT_Utility.copyAmount(1L, aStack), MaterialsOld.Water.getFluid(125L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.HydratedCoal, 1L), 125);
                break;
            case HydratedCoal:
                GT_ModHandler.addLiquidTransposerEmptyRecipe(GT_Utility.copyAmount(1L, aStack), MaterialsOld.Water.getFluid(125L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Coal, 1L), 125);
                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Coal, 1L));
                break;
            case Diamond:
                RECIPE_ADDER_INSTANCE.addImplosionRecipe(GT_Utility.copyAmount(4L, aStack), 32, ItemList.IC2_Industrial_Diamond.get(3L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.DarkAsh, 16L));
                break;
            case Opal:
            case Olivine:
            case Emerald:
            ...
            case BlueTopaz:
            case Tanzanite:
                RECIPE_ADDER_INSTANCE.addImplosionRecipe(GT_Utility.copyAmount(4L, aStack), 24, GT_OreDictUnificator.get(OrePrefixes.gem, aMaterial, 3L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.DarkAsh, 12L));
                break;
            case FoolsRuby:
            case GarnetRed:
            case GarnetYellow:
            ...
            case Forcillium:
                ...
                RECIPE_ADDER_INSTANCE.addImplosionRecipe(GT_Utility.copyAmount(4L, aStack), 16, GT_OreDictUnificator.get(OrePrefixes.gem, aMaterial, 3L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.DarkAsh, 8L));
        }
    }
}
