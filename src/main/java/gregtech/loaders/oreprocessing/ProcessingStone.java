...
public class ProcessingStone
    ...
    public void registerOre(OrePrefixes aPrefix, MaterialsOld aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        switch (aMaterial) {
            case _NULL:
                RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_Utility.copyAmount(3L, aStack), new ItemStack(Blocks.redstone_torch, 2), MaterialsOld.Redstone.getMolten(144L), new ItemStack(Items.repeater, 1), 100, 4);
                break;
            case Sand:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1L, aStack), new ItemStack(Blocks.sand, 1, 0), null, 10, false);
                break;
            case Endstone:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, MaterialsOld.Endstone, 1L), GT_OreDictUnificator.get(OrePrefixes.dustTiny, MaterialsOld.Tungsten, 1L), 5, false);
                break;
            case Netherrack:
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, MaterialsOld.Netherrack, 1L), GT_OreDictUnificator.get(OrePrefixes.nugget, MaterialsOld.Gold, 1L), 5, false);
                break;
            case NetherBrick:
            ...
            case Obsidian:
                ...
                RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Redstone, 2L), GT_Utility.copyAmount(5L, aStack), MaterialsOld.Glass.getMolten(72L), GT_ModHandler.getModItem(MOD_ID_FR, "thermionicTubes", 4L, 6), 64, 32);
                RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, MaterialsOld.NetherStar, 1L), GT_Utility.copyAmount(3L, aStack), MaterialsOld.Glass.getMolten(720L), new ItemStack(Blocks.beacon, 1, 0), 32, 16);
                ...
                RECIPE_ADDER_INSTANCE.addAssemblerRecipe(GT_Utility.copyAmount(8L, aStack), GT_OreDictUnificator.get(OrePrefixes.gem, MaterialsOld.EnderEye, 1L), new ItemStack(Blocks.ender_chest, 1), 400, 4);
            ...
            case GraniteBlack:
                RECIPE_ADDER_INSTANCE.addCutterRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 1L), null, 200, 32);
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, aMaterial, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, MaterialsOld.Thorium, 1L), 1, false);
                break;
            case GraniteRed:
                RECIPE_ADDER_INSTANCE.addCutterRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 1L), null, 200, 32);
                GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.dustImpure, aMaterial, 1L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, MaterialsOld.Uranium, 1L), 1, false);
        }
    }
}
