...
public class GT_CraftingRecipeLoader
    ...
    public void run() {
        ...
        GT_ModHandler.addCraftingRecipe(new ItemStack(Items.stick, 2, 0), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"s", "X", 'X', new ItemStack(Blocks.deadbush, 1, GT_Values.W)});
        ...
        GT_ModHandler.addCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadArrow, Materials.Flint, 1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"f", "X", 'X', new ItemStack(Items.flint, 1, GT_Values.W)});

        GT_ModHandler.addCraftingRecipe(new ItemStack(Items.arrow, 1), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE | GT_ModHandler.RecipeBits.DELETE_ALL_OTHER_SHAPED_RECIPES, new Object[]{"  H", " S ", "F  ", 'H', new ItemStack(Items.flint, 1, GT_Values.W), 'S', OrePrefixes.stick.get(Materials.Wood), 'F', OreDictNames.craftingFeather});
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getRecipeOutput(null, new ItemStack(Blocks.sand, 1, 0), null, null, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Apatite, 1L), null, null, new ItemStack(Blocks.sand, 1, 0), null), new Object[]{"S", "A", "S", 'A', OrePrefixes.dust.get(Materials.Apatite), 'S', new ItemStack(Blocks.sand, 1, GT_Values.W)});
        ...
        GT_ModHandler.addRollingMachineRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "post.metal.light.blue", 8L), new Object[]{"XXX", " X ", "XXX", 'X', OrePrefixes.ingot.get(Materials.Aluminium).toString()});
        GT_ModHandler.addRollingMachineRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "post.metal.purple", 64L), new Object[]{"XXX", " X ", "XXX", 'X', OrePrefixes.ingot.get(Materials.Titanium).toString()});
        GT_ModHandler.addRollingMachineRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "post.metal.black", 64L), new Object[]{"XXX", " X ", "XXX", 'X', OrePrefixes.ingot.get(Materials.Tungsten).toString()});

        GT_ModHandler.addRollingMachineRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "post.metal.light.blue", 8L), new Object[]{"X X", "XXX", "X X", 'X', OrePrefixes.ingot.get(Materials.Aluminium).toString()});
        GT_ModHandler.addRollingMachineRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "post.metal.purple", 64L), new Object[]{"X X", "XXX", "X X", 'X', OrePrefixes.ingot.get(Materials.Titanium).toString()});
        GT_ModHandler.addRollingMachineRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "post.metal.black", 64L), new Object[]{"X X", "XXX", "X X", 'X', OrePrefixes.ingot.get(Materials.Tungsten).toString()});
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 2L, 3), tBitMask | GT_ModHandler.RecipeBits.MIRRORED, new Object[]{tHammer + GT_Values.E + tFile, "XX", "XX", 'X', tIngot.get(Materials.Tin)});

        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 0), tBitMask, new Object[]{tHammer + "X ", "XGX", " X" + tFile, 'X', OrePrefixes.nugget.get(Materials.Gold), 'G', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 3)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 1), tBitMask, new Object[]{tHammer + "X ", "XGX", " X" + tFile, 'X', tIngot.get(Materials.AnyIron), 'G', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 3)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 2), tBitMask, new Object[]{tHammer + "X ", "XGX", " X" + tFile, 'X', tIngot.get(Materials.Steel), 'G', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 3)});

        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 8L, 0), tBitMask, new Object[]{tWrench + "PP", tHammer + "PP", 'P', OrePrefixes.plate.get(Materials.AnyIron)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 8L, 1), tBitMask, new Object[]{"GPG", "PGP", "GPG", 'P', OrePrefixes.plate.get(Materials.AnyIron), 'G', new ItemStack(Blocks.glass_pane, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 8L, 2), tBitMask, new Object[]{"BPB", "PLP", "BPB", 'P', OrePrefixes.plate.get(Materials.AnyIron), 'B', new ItemStack(Blocks.iron_bars, 1, GT_Values.W), 'L', new ItemStack(Blocks.lever, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 3), tBitMask, new Object[]{tWrench + "P", tHammer + "P", 'P', OrePrefixes.plate.get(Materials.AnyIron)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 4), tBitMask, new Object[]{tWrench + "P", tHammer + "P", 'P', OrePrefixes.plate.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 5), tBitMask, new Object[]{"BBB", "BFB", "BOB", 'B', OrePrefixes.ingot.get(Materials.Brick), 'F', new ItemStack(Items.fire_charge, 1, GT_Values.W), 'O', OreDictNames.craftingFurnace});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 6), tBitMask, new Object[]{"PUP", "BFB", "POP", 'P', OrePrefixes.plate.get(Materials.Steel), 'B', new ItemStack(Blocks.iron_bars, 1, GT_Values.W), 'F', new ItemStack(Items.fire_charge, 1, GT_Values.W), 'U', OrePrefixes.bucket.get(Materials.Empty), 'O', OreDictNames.craftingFurnace});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 7), tBitMask | GT_ModHandler.RecipeBits.MIRRORED, new Object[]{"PPP", tHammer + "G" + tWrench, "OTO", 'P', OrePrefixes.nugget.get(Materials.Gold), 'O', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 0), 'G', new ItemStack(Blocks.glass, 1, GT_Values.W), 'T', OreDictNames.craftingPiston});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 8), tBitMask | GT_ModHandler.RecipeBits.MIRRORED, new Object[]{"PPP", tHammer + "G" + tWrench, "OTO", 'P', OrePrefixes.plate.get(Materials.AnyIron), 'O', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 1), 'G', new ItemStack(Blocks.glass, 1, GT_Values.W), 'T', OreDictNames.craftingPiston});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 9), tBitMask | GT_ModHandler.RecipeBits.MIRRORED, new Object[]{"PPP", tHammer + "G" + tWrench, "OTO", 'P', OrePrefixes.plate.get(Materials.Steel), 'O', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 2), 'G', new ItemStack(Blocks.glass, 1, GT_Values.W), 'T', OreDictNames.craftingPiston});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 10), tBitMask, new Object[]{" E ", " O ", "OIO", 'I', tIngot.get(Materials.Gold), 'E', OrePrefixes.gem.get(Materials.EnderPearl), 'O', OrePrefixes.stone.get(Materials.Obsidian)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 11), tBitMask, new Object[]{"OOO", "OEO", "OOO", 'E', OrePrefixes.gem.get(Materials.EnderPearl), 'O', OrePrefixes.stone.get(Materials.Obsidian)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 12), tBitMask, new Object[]{"GPG", "PAP", "GPG", 'P', OreDictNames.craftingPiston, 'A', OreDictNames.craftingAnvil, 'G', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 2)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 8L, 13), tBitMask, new Object[]{tWrench + "PP", tHammer + "PP", 'P', OrePrefixes.plate.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 8L, 14), tBitMask, new Object[]{"GPG", "PGP", "GPG", 'P', OrePrefixes.plate.get(Materials.Steel), 'G', new ItemStack(Blocks.glass_pane, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 8L, 15), tBitMask, new Object[]{"BPB", "PLP", "BPB", 'P', OrePrefixes.plate.get(Materials.Steel), 'B', new ItemStack(Blocks.iron_bars, 1, GT_Values.W), 'L', new ItemStack(Blocks.lever, 1, GT_Values.W)});
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 0), tBitMask, new Object[]{"IOI", "GEG", "IOI", 'I', tIngot.get(Materials.Gold), 'G', OrePrefixes.gem.get(Materials.Diamond), 'E', OrePrefixes.gem.get(Materials.EnderPearl), 'O', OrePrefixes.stone.get(Materials.Obsidian)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 3L, 1), tBitMask, new Object[]{"BPB", "P" + tWrench + "P", "BPB", 'P', OrePrefixes.plate.get(Materials.Steel), 'B', OrePrefixes.block.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 2), tBitMask, new Object[]{"IOI", "GEG", "IOI", 'I', tIngot.get(Materials.Gold), 'G', OrePrefixes.gem.get(Materials.Emerald), 'E', OrePrefixes.gem.get(Materials.EnderPearl), 'O', OrePrefixes.stone.get(Materials.Obsidian)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 4L, 3), tBitMask, new Object[]{"PPP", "PFP", "PPP", 'P', OrePrefixes.plate.get(Materials.Steel), 'F', OreDictNames.craftingFurnace});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 5), tBitMask, new Object[]{" N ", "RCR", 'R', OrePrefixes.dust.get(Materials.Redstone), 'N', OrePrefixes.stone.get(Materials.Netherrack), 'C', new ItemStack(Items.cauldron, 1, 0)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 6), tBitMask, new Object[]{"SGS", "EDE", "SGS", 'E', OrePrefixes.gem.get(Materials.Emerald), 'S', OrePrefixes.plate.get(Materials.Steel), 'G', new ItemStack(Blocks.glass_pane, 1, GT_Values.W), 'D', new ItemStack(Blocks.dispenser, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 8), tBitMask, new Object[]{"IPI", "PCP", "IPI", 'P', OreDictNames.craftingPiston, 'I', tIngot.get(Materials.AnyIron), 'C', new ItemStack(Blocks.crafting_table, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 9), tBitMask, new Object[]{" I ", " T ", " D ", 'I', new ItemStack(Blocks.iron_bars, 1, GT_Values.W), 'T', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 4), 'D', new ItemStack(Blocks.dispenser, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 10), tBitMask, new Object[]{" I ", "RTR", " D ", 'I', new ItemStack(Blocks.iron_bars, 1, GT_Values.W), 'T', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 4), 'D', new ItemStack(Blocks.dispenser, 1, GT_Values.W), 'R', OrePrefixes.dust.get(Materials.Redstone)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 10), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"RTR", 'T', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 9), 'R', OrePrefixes.dust.get(Materials.Redstone)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 11), tBitMask, new Object[]{"PCP", "CSC", "PCP", 'P', OrePrefixes.plank.get(Materials.Wood), 'S', OrePrefixes.plate.get(Materials.Steel), 'C', new ItemStack(Items.golden_carrot, 1, 0)});
        if (GregTech_API.sMachineFile.get(ConfigCategories.machineconfig, "DisableRCBlastFurnace", false)) {
            GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 4L, 12));
        }
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 1L, 13), tBitMask, new Object[]{"TSB", "SCS", "PSP", 'P', OreDictNames.craftingPiston, 'S', OrePrefixes.plate.get(Materials.Steel), 'B', OreDictNames.craftingBook, 'C', new ItemStack(Blocks.crafting_table, 1, GT_Values.W), 'T', new ItemStack(Items.diamond_pickaxe, 1, 0)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 6L, 14), tBitMask, new Object[]{"PPP", "ISI", "PPP", 'P', OrePrefixes.plank.get(Materials.Wood), 'I', tIngot.get(Materials.AnyIron), 'S', "slimeball"});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCA, 4L, 15), tBitMask, new Object[]{"PDP", "DBD", "PDP", 'P', OreDictNames.craftingPiston, 'B', OrePrefixes.block.get(Materials.Steel), 'D', OrePrefixes.gem.get(Materials.Diamond)});

        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "machine.epsilon", 1L, 0), tBitMask, new Object[]{"PWP", "WWW", "PWP", 'P', OrePrefixes.plate.get(Materials.AnyIron), 'W', OrePrefixes.wireGt02.get(Materials.Copper)});

        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "tool.crowbar", 1L, 0), tBitMask, new Object[]{tHammer + "DS", "DSD", "SD" + tFile, 'S', OrePrefixes.ingot.get(Materials.Iron), 'D', Dyes.dyeRed});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "tool.crowbar.reinforced", 1L, 0), tBitMask, new Object[]{tHammer + "DS", "DSD", "SD" + tFile, 'S', OrePrefixes.ingot.get(Materials.Steel), 'D', Dyes.dyeRed});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "tool.whistle.tuner", 1L, 0), tBitMask | GT_ModHandler.RecipeBits.MIRRORED, new Object[]{"S" + tHammer + "S", "SSS", " S" + tFile, 'S', OrePrefixes.nugget.get(Materials.Iron)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "part.turbine.blade", 1L, 0), tBitMask, new Object[]{"S" + tFile, "S ", "S" + tHammer, 'S', tIngot.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "part.turbine.disk", 1L, 0), tBitMask, new Object[]{"SSS", "SBS", "SSS", 'B', OrePrefixes.block.get(Materials.Steel), 'S', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "part.turbine.blade", 1L, 0)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "part.turbine.rotor", 1L, 0), tBitMask, new Object[]{"SSS", " " + tWrench + " ", 'S', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "part.turbine.disk", 1L, 0)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "borehead.iron", 1L, 0), tBitMask, new Object[]{"SSS", "SBS", "SSS", 'B', OrePrefixes.block.get(Materials.Iron), 'S', tIngot.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "borehead.steel", 1L, 0), tBitMask, new Object[]{"SSS", "SBS", "SSS", 'B', OrePrefixes.block.get(Materials.Steel), 'S', tIngot.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "borehead.diamond", 1L, 0), tBitMask, new Object[]{"SSS", "SBS", "SSS", 'B', OrePrefixes.block.get(Materials.Diamond), 'S', tIngot.get(Materials.Steel)});

        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "cart.loco.steam.solid", 1L, 0), tBitMask, new Object[]{"TTF", "TTF", "BCC", 'C', new ItemStack(Items.minecart, 1), 'T', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 4), 'F', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCB, 1L, 5), 'B', new ItemStack(Blocks.iron_bars, 1, GT_Values.W)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "cart.loco.electric", 1L, 0), tBitMask, new Object[]{"LP" + tWrench, "PEP", "GCG", 'C', new ItemStack(Items.minecart, 1), 'E', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "machine.epsilon", 1L, 0), 'G', GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, RCGEAR, 1L, 2), 'L', new ItemStack(Blocks.redstone_lamp, 1, GT_Values.W), 'P', OrePrefixes.plate.get(Materials.Steel)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_RC, "cart.bore", 1L, 0), tBitMask, new Object[]{"BCB", "FCF", tHammer + "A" + tWrench, 'C', new ItemStack(Items.minecart, 1), 'A', new ItemStack(Items.chest_minecart, 1), 'F', OreDictNames.craftingFurnace, 'B', OrePrefixes.block.get(Materials.Steel)});
        ...
        if (GT_Mod.gregtechproxy.mDisableIC2Cables) {
            ...
            GT_ModHandler.addCraftingRecipe(GT_ModHandler.getIC2Item(GFIBER, 1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"GGG", "EDE", "GGG", 'G', new ItemStack(Blocks.glass, 1, GT_Values.W), 'D', OrePrefixes.dust.get(Materials.Silver), 'E', ItemList.IC2_Energium_Dust.get(1L)});
        }
        ...
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getIC2Item(LCRYST, 1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"LCL", "LSL", "LCL", 'C', OrePrefixes.circuit.get(Materials.Advanced), 'S', GT_ModHandler.getIC2Item("energyCrystal", 1L, GT_Values.W), 'L', OrePrefixes.dust.get(Materials.Lazurite)});
        GT_ModHandler.addCraftingRecipe(GT_ModHandler.getIC2Item(LCRYST, 1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"LCL", "LSL", "LCL", 'C', OrePrefixes.circuit.get(Materials.Advanced), 'S', GT_ModHandler.getIC2Item("energyCrystal", 1L, GT_Values.W), 'L', OrePrefixes.dust.get(Materials.Lapis)});
        ...
        if (Loader.isModLoaded(GT_Values.MOD_ID_GS)) {
            GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, GSITEM, 1, 6));
            GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, GSITEM, 1, 6), new Object[]{"GPG", "CUC", "PVP", 'G', OrePrefixes.dust.get(Materials.Glowstone), 'P', GT_ModHandler.getIC2Item("advancedAlloy", 1), 'C', OrePrefixes.circuit.get(Materials.Advanced),'U', OrePrefixes.plate.get(Materials.Titanium), 'V', OrePrefixes.plate.get(Materials.StainlessSteel)});
        }
        if (Loader.isModLoaded(GT_Values.MOD_ID_GS) && (GT_Mod.gregtechproxy.mDisableIC2Cables)) {
            GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, ADVJET, 1));
            GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, ADVJET, 1), new Object[]{"PJP", "BLB", "WCW", 'P', OrePrefixes.plateAlloy.get(Materials.Carbon), 'J', GT_ModHandler.getIC2Item("electricJetpack", 1), 'B', GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, GSITEM, 1, 6), 'L', GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, "advLappack", 1), 'W', OrePrefixes.wireGt04.get(Materials.Platinum), 'C', OrePrefixes.circuit.get(Materials.Advanced)});

            GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, GSITEM, 3, 1));
            GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, GSITEM, 3, 1), new Object[]{"CCC", "WWW", "CCC", 'C', GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, GSITEM, 1), 'W', OrePrefixes.wireGt01.get(Materials.Superconductor)});

            GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, "advNanoChestPlate", 1));
            GT_ModHandler.addCraftingRecipe(GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, "advNanoChestPlate", 1), new Object[]{"PJP", "PLP", "WCW", 'P', OrePrefixes.plateAlloy.get(Materials.Carbon), 'J', GT_ModHandler.getModItem(GT_Values.MOD_ID_GS, ADVJET, 1), 'L', GT_ModHandler.getIC2Item("nanoBodyarmor", 1), 'W', OrePrefixes.wireGt04.get(Materials.Platinum), 'C', OrePrefixes.circuit.get(Materials.Advanced)});
        }
        ...
        if (GT_OreDictUnificator.get(OrePrefixes.gear, Materials.Diamond, 1L) != null) {
            ...
            if (GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.harderrecipes, "quarry", true)) {
                ...
                GT_ModHandler.addCraftingRecipe(tStack, GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"ICI", "GIG", "DPD", 'C', OrePrefixes.circuit.get(Materials.Advanced), 'D', OrePrefixes.gear.get(Materials.Diamond), 'G', OrePrefixes.gear.get(Materials.Gold), 'I', OrePrefixes.gear.get(Materials.Steel), 'P', GT_ModHandler.getIC2Item(DRILL2, 1L, GT_Values.W)});
            }
        ...
        if (GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2Item(DRILL2, 1L))) {
            GT_ModHandler.addCraftingRecipe(GT_ModHandler.getIC2Item(DRILL2, 1L), GT_ModHandler.RecipeBits.BUFFERED | GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{" D ", "DMD", "TAT", 'M', GT_ModHandler.getIC2Item(DRILL1, 1L, GT_Values.W), 'D', OreDictNames.craftingIndustrialDiamond, 'T', OrePrefixes.plate.get(Materials.Titanium), 'A', OrePrefixes.circuit.get(Materials.Advanced)});
        }
