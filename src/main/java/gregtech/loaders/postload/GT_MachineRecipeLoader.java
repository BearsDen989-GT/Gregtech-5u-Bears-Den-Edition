...
implements Runnable {
	...
	public void run() {
        ...
        /* Feild Generators */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 4L) , (new ItemStack(Items.ender_pearl, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 4L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_LV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 4L) , (new ItemStack(Items.ender_eye, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 8L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_MV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 16L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_HV.get(1L, new Object[0])), 100, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 32L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_EV.get(1L, new Object[0])), 100, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 64L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_IV.get(1L, new Object[0])), 100, 256);
