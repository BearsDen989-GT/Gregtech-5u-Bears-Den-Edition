...
implements Runnable {
	...
	public void run() {
		...
		GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell,Materials.NitrogenDioxide,4), GT_OreDictUnificator.get(OrePrefixes.cell,Materials.Oxygen,1), Materials.Water.getFluid(2000), new FluidStack(ItemList.sNitricAcid,4000), ItemList.Cell_Empty.get(5, new Object[0]), 30);
		GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.crushedPurified,Materials.Pentlandite,1), null, new FluidStack(ItemList.sNitricAcid,8000), new FluidStack(ItemList.sNickelSulfate,9000), ItemList.PlatinumGroupSludgeTiny.get(1, new Object[0]) ,30);
		GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.crushedPurified,Materials.Chalcopyrite,1), null, new FluidStack(ItemList.sNitricAcid,8000), new FluidStack(ItemList.sBlueVitriol,9000), ItemList.PlatinumGroupSludgeTiny.get(1, new Object[0]), 30);
		...
		GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 2L),  GT_OreDictUnificator.get(OrePrefixes.dustPure, Materials.BandedIron, 5L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 3L),  GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silicon, 1L), 100, 120, 1200);
        ...
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SulfurDioxide, 1L), GT_Values.NI , GT_Values.NI, GT_Values.NI, Materials.Water.getFluid(2000L), Materials.SulfuricAcid.getFluid(3000L),ItemList.Cell_Empty.get(1L, new Object[0]), 1150, 30);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 2L), GT_Values.NI , GT_Values.NI, GT_Values.NI, Materials.SulfurDioxide.getGas(1000L), Materials.SulfuricAcid.getFluid(3000L),ItemList.Cell_Empty.get(2L, new Object[0]), 1150, 30);
        ...
        /* Part Assembler recipes */

		/* Electric Motors*/
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.IronMagnetic, 1L), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.AnyCopper, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2L)) , GT_Values.NI, GT_Values.NI, (ItemList.Electric_Motor_LV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.SteelMagnetic, 1L), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.AnyCopper, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2L)), GT_Values.NI, GT_Values.NI, (ItemList.Electric_Motor_LV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.SteelMagnetic, 1L), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Aluminium, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.AnyCopper, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnyCopper, 2L)), GT_Values.NI, GT_Values.NI, (ItemList.Electric_Motor_MV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.SteelMagnetic, 1L), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.wireGt04, Materials.AnyCopper, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 2L)), GT_Values.NI, GT_Values.NI, (ItemList.Electric_Motor_HV.get(1L, new Object[0])), 100, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.NeodymiumMagnetic, 1L), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Titanium, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.wireGt08, Materials.AnnealedCopper, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 2L)), GT_Values.NI, GT_Values.NI, (ItemList.Electric_Motor_EV.get(1L, new Object[0])), 100, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.NeodymiumMagnetic, 1L), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.TungstenSteel, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.wireGt16, Materials.AnnealedCopper, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 2L)), GT_Values.NI, GT_Values.NI, (ItemList.Electric_Motor_IV.get(1L, new Object[0])), 100, 256);

        /* Electric Pumps*/
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Tin, 2L), (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Tin, 4L)) , (GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Rubber, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Bronze, 1L)) , (ItemList.Electric_Motor_LV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 1L)), (ItemList.Electric_Pump_LV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Bronze, 2L), (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Bronze, 4L)) , (GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Rubber, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Steel, 1L)) , (ItemList.Electric_Motor_MV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnyCopper, 1L)), (ItemList.Electric_Pump_MV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.Steel, 2L), (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L)) , (GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Rubber, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.StainlessSteel, 1L)) , (ItemList.Electric_Motor_HV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 1L)), (ItemList.Electric_Pump_HV.get(1L, new Object[0])), 200, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.StainlessSteel, 2L), (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 4L)) , (GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Rubber, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Titanium, 1L)) , (ItemList.Electric_Motor_EV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 1L)), (ItemList.Electric_Pump_EV.get(1L, new Object[0])), 200, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.screw, Materials.TungstenSteel, 2L), (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 4L)) , (GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Rubber, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.TungstenSteel, 1L)) , (ItemList.Electric_Motor_IV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 1L)), (ItemList.Electric_Pump_IV.get(1L, new Object[0])), 200, 256);

        /* Conveyors */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Rubber, 4L) , (ItemList.Electric_Motor_LV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 1L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Conveyor_Module_LV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Rubber, 4L) , (ItemList.Electric_Motor_MV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Copper, 1L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Conveyor_Module_MV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Rubber, 4L) , (ItemList.Electric_Motor_HV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 1L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Conveyor_Module_HV.get(1L, new Object[0])), 100, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Rubber, 4L) , (ItemList.Electric_Motor_EV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 1L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Conveyor_Module_EV.get(1L, new Object[0])), 100, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Rubber, 4L) , (ItemList.Electric_Motor_IV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 1L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Conveyor_Module_IV.get(1L, new Object[0])), 100, 256);

        /* Electric Pistons */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L) , (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 2L)) , (ItemList.Electric_Motor_LV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2L)) , GT_Values.NI, GT_Values.NI, (ItemList.Electric_Piston_LV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 4L) , (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Aluminium, 2L)) , (ItemList.Electric_Motor_MV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnyCopper, 2L)) , GT_Values.NI, GT_Values.NI, (ItemList.Electric_Piston_MV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 4L) , (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 2L)) , (ItemList.Electric_Motor_HV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 2L)) , GT_Values.NI, GT_Values.NI, (ItemList.Electric_Piston_HV.get(1L, new Object[0])), 200, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 4L) , (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Titanium, 2L)) , (ItemList.Electric_Motor_EV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 2L)) , GT_Values.NI, GT_Values.NI, (ItemList.Electric_Piston_EV.get(1L, new Object[0])), 200, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 4L) , (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.TungstenSteel, 2L)) , (ItemList.Electric_Motor_IV.get(1L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 2L)) , GT_Values.NI, GT_Values.NI, (ItemList.Electric_Piston_IV.get(1L, new Object[0])), 200, 256);

        /* Robot Arms */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L) , (ItemList.Electric_Piston_LV.get(1L, new Object[0])) , (ItemList.Electric_Motor_LV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2L)), GT_Values.NI, (ItemList.Robot_Arm_LV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 1L) , (ItemList.Electric_Piston_MV.get(1L, new Object[0])) , (ItemList.Electric_Motor_MV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Aluminium, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnyCopper, 2L)), GT_Values.NI, (ItemList.Robot_Arm_MV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 1L) , (ItemList.Electric_Piston_HV.get(1L, new Object[0])) , (ItemList.Electric_Motor_HV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 2L)), GT_Values.NI, (ItemList.Robot_Arm_HV.get(1L, new Object[0])), 200, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 1L) , (ItemList.Electric_Piston_EV.get(1L, new Object[0])) , (ItemList.Electric_Motor_EV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Titanium, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 2L)), GT_Values.NI, (ItemList.Robot_Arm_EV.get(1L, new Object[0])), 200, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1L) , (ItemList.Electric_Piston_IV.get(1L, new Object[0])) , (ItemList.Electric_Motor_IV.get(2L, new Object[0])), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.TungstenSteel, 2L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 2L)), GT_Values.NI, (ItemList.Robot_Arm_IV.get(1L, new Object[0])), 200, 256);

        /* Feild Generators */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 4L) , (new ItemStack(Items.ender_pearl, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 2L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_LV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 4L) , (new ItemStack(Items.ender_eye, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.Osmium, 2L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_MV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt04, Materials.Osmium, 2L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_HV.get(1L, new Object[0])), 100, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt08, Materials.Osmium, 2L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_EV.get(1L, new Object[0])), 100, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt16, Materials.Osmium, 2L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_IV.get(1L, new Object[0])), 100, 256);

        /* Emitters */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 2L) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Brass, 2L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_LV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 2L) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnyCopper, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Electrum, 2L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_MV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 2L) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Emerald, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Chrome, 2L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_HV.get(1L, new Object[0])), 200, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 2L) , (new ItemStack(Items.ender_pearl, 1, 1)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Platinum, 2L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_EV.get(1L, new Object[0])), 200, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 2L) , (new ItemStack(Items.ender_eye, 1, 1)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Osmium, 2L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_IV.get(1L, new Object[0])), 200, 256);

        /* Sensors */
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 3L)) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite, 1L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Brass, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_LV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 3L)) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz, 1L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Electrum, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_MV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 3L)) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Emerald, 1L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Chrome, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_HV.get(1L, new Object[0])), 200, 64);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 3L)) , (new ItemStack(Items.ender_pearl, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Platinum, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_EV.get(1L, new Object[0])), 200, 256);
        GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 3L)) , (new ItemStack(Items.ender_eye, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Osmium, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_IV.get(1L, new Object[0])), 200, 256);


        /* Better Jetpack recipe using Dragon Egg */
        GT_ModHandler.removeRecipeByOutput(GT_ModHandler.getIC2Item("electricJetpack", 1L));
        if (GT_Mod.gregtechproxy.mDisableIC2Cables) {
            GT_Values.RA.addPartAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 1L), GT_ModHandler.getIC2Item("casingiron", 4L), (ItemList.Battery_Buffer_1by1_LV.get(1L, new Object[0])), (new ItemStack(Items.glowstone_dust, 2, 0)), (new ItemStack(Blocks.dragon_egg, 0, 0)), GT_Values.NI, (GT_ModHandler.getIC2Item("electricJetpack", 1L)), 200, 16);
        } else {
