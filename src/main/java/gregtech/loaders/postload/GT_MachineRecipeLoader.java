...
//		GT_Values.RA.addPyrolyseRecipe(GT_ModHandler.getIC2Item("biochaff", 1), Materials.Water.getFluid(1000), 1, null, new FluidStack(FluidRegistry.getFluid("ic2biomass"), 1500), 100, 10);
		...
		GT_Values.RA.addPyrolyseRecipe(new ItemStack(Blocks.reeds, 24), null, 1, (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Charcoal, 12)),   Materials.Water.getFluid(11000), 320, 32);
		GT_Values.RA.addPyrolyseRecipe(new ItemStack(Blocks.reeds, 24), Materials.Nitrogen.getGas(500), 2, (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Charcoal, 12)),   Materials.Water.getFluid(11000), 160, 64);
