...
//            GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RockSalt, 1L), tFluid, FluidRegistry.getFluid("potion.saltywater"), true);
	...
	if (GT_Mod.gregtechproxy.mBearCoreRecipes) {
            GT_Values.RA.addElectrolyzerRecipe(GT_Values.NI, GT_Values.NI, Materials.Magnesiumchloride.getMolten(432L), Materials.Chlorine.getGas(2000L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium, 1L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 300, 240);
	} else {
