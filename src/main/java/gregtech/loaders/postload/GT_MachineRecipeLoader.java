...
implements Runnable {
	...
	public void run() {
		...
		GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 2L),  GT_OreDictUnificator.get(OrePrefixes.ore, Materials.BandedIron, 5L), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 3L),  GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silicon, 1L), 100, 120, 1200);
