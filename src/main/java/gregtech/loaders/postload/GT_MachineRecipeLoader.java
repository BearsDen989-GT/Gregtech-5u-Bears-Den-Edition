...
implements Runnable {
	...
	public void run() {
		...
		GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Chalcopyrite, 1L), Materials.Air.getGas(4000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Copper, 1L)), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iron, 1L)), GT_Values.NI ,Materials.SulfurDioxide.getGas(1000L),null, 512, 16);
		GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Molybdenite, 1L), Materials.Air.getGas(6000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Molybdenum, 1L)), GT_Values.NI, GT_Values.NI ,Materials.SulfurDioxide.getGas(200L),null, 512, 16);
		GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Cobaltite, 1L), Materials.Air.getGas(3000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Cobalt, 1L)), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Arsenic, 1L)), GT_Values.NI ,Materials.SulfurDioxide.getGas(1000L),null, 512, 16);
		GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pentlandite, 1L), Materials.Air.getGas(8000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Nickel, 2L)), GT_Values.NI , GT_Values.NI ,Materials.SulfurDioxide.getGas(1000L),null, 512, 16);
        GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stibnite, 1L), Materials.Air.getGas(5000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Antimony, 1L)), GT_Values.NI , GT_Values.NI ,Materials.SulfurDioxide.getGas(1000L),null, 512, 16);
        GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sphalerite, 1L), Materials.Air.getGas(4000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Zinc, 2L)), GT_Values.NI , GT_Values.NI ,Materials.SulfurDioxide.getGas(1000L),null, 512, 16);
        GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Galena, 1L), Materials.Air.getGas(2000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Silver, 1L)), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Lead, 1L)) , GT_Values.NI ,Materials.SulfurDioxide.getGas(500L),null, 512, 16);
        GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Pyrite, 1L), Materials.Air.getGas(3000L), (GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Iron, 1L)), GT_Values.NI , GT_Values.NI ,Materials.SulfurDioxide.getGas(1000L),null, 512, 16);
        GT_Values.RA.addRoasterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur, 1L), Materials.Air.getGas(8000L), (GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Sulfur, 1L)), GT_Values.NI, GT_Values.NI , Materials.SulfurDioxide.getGas(3000L), new int[]{1000} , 512, 16);
        ...
        /* Feild Generators */
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 4L) , (new ItemStack(Items.ender_pearl, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 4L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_LV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 4L) , (new ItemStack(Items.ender_eye, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 8L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_MV.get(1L, new Object[0])), 100, 16);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 16L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_HV.get(1L, new Object[0])), 100, 64);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 32L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_EV.get(1L, new Object[0])), 100, 256);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 4L) , (new ItemStack(Items.nether_star, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Osmium, 64L)), GT_Values.NI , GT_Values.NI, GT_Values.NI, (ItemList.Field_Generator_IV.get(1L, new Object[0])), 100, 256);

        /* Emitters */
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Basic, 2L) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Brass, 4L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_LV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Good, 2L) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnyCopper, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Electrum, 4L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_MV.get(1L, new Object[0])), 200, 16);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 2L) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Emerald, 1L)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Chrome, 4L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_HV.get(1L, new Object[0])), 200, 64);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite, 2L) , (new ItemStack(Items.ender_pearl, 1, 1)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Platinum, 4L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_EV.get(1L, new Object[0])), 200, 256);
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 2L) , (new ItemStack(Items.ender_eye, 1, 1)) , (GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 2L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Osmium, 4L)) , GT_Values.NI , GT_Values.NI, (ItemList.Emitter_IV.get(1L, new Object[0])), 200, 256);
        ...
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 4L)) , (GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Emerald, 1L)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Chrome, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_HV.get(1L, new Object[0])), 200, 64);
        ...
        GT_Values.RA.addPartFactoryRecipe(GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master, 1L) , (GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 4L)) , (new ItemStack(Items.ender_eye, 1, 1)), (GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Osmium, 1L)) , GT_Values.NI , GT_Values.NI, (ItemList.Sensor_IV.get(1L, new Object[0])), 200, 256);
