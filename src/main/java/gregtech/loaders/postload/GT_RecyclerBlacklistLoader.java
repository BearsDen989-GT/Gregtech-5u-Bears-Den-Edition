...
public class GT_RecyclerBlacklistLoader
    ...
    public void run() {
        ...
        if (GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.disabledrecipes, "easystonerecycling", true)) {
            ...
            GT_ModHandler.addToRecyclerBlackList(new ItemStack(Blocks.gravel, 1, OreDictionary.WILDCARD_VALUE));
            GT_ModHandler.addToRecyclerBlackList(new ItemStack(Items.flint, 1, OreDictionary.WILDCARD_VALUE));
            GT_ModHandler.addToRecyclerBlackList(new ItemStack(Blocks.cobblestone_wall, 1, OreDictionary.WILDCARD_VALUE));
            GT_ModHandler.addToRecyclerBlackList(new ItemStack(Blocks.sandstone_stairs, 1, OreDictionary.WILDCARD_VALUE));
            GT_ModHandler.addToRecyclerBlackList(new ItemStack(Blocks.stone_stairs, 1, OreDictionary.WILDCARD_VALUE));
            GT_ModHandler.addToRecyclerBlackList(new ItemStack(Blocks.stone_brick_stairs, 1, OreDictionary.WILDCARD_VALUE));
